        ...
        if (GAME && "parseidin" in GAME && GAME.parseidin != null && GAME.parseidin() && checked) {
            ...
            class kwsv3 {
                constructor() {
                    ...
                    this.addToCSS(`#secondary_char_stats .instance{margin-top:10px; cursor:pointer;} #secondary_char_stats .activities{margin-top:-5px; cursor:pointer;} #secondary_char_stats ul {margin-top:-18px; margin-left:-18px;} .ico.a11{background:url("https://nonono.cba.pl/app/src/images/instances.png"); background-repeat: no-repeat; background-size: inherit; background-position: center;} .ico.a12{background-image: url(https://nonono.cba.pl/app/src/images/activity.png); background-repeat: no-repeat; background-size: inherit; background-position: center;}`);
            ...
            GAME.cached_data = function() {
                ...
                setTimeout(() => {
                    if (GAME.char_data.planetary == 0 && GAME.pid != 322483) {
                        setTimeout(() => {
                            GAME.socket.emit('ga', {
                                a: 39,
                                type: 34
